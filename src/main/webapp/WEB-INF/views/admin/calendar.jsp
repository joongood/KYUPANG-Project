              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    <div class="external-event bg-success">점심</div>
                    <div class="external-event bg-warning">퇴근</div>
                    <div class="external-event bg-info">업무</div>
                    <div class="external-event bg-primary">UI 디자인</div>
                    <div class="checkbox">
