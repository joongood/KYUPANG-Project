            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><b>가맹점 목록</b></h3>
         		  <div class="btn-group" style="margin-left:87%;">
 					<button type="button" class="btn btn-primary" onclick="popup('/admin/manageStore/addStore')">가맹점추가</button>        		  
         		  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="memberTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <c:forEach var="store" items="${storeList}">
                        <tr>
                          <td>${number }</td>
                          <td><a onclick="popup('/admin/manageStore/detailStore?sid=${store.sid }')">${store.mutual}</a></td>
