    	...
    	<div class="content-wrapper" style="width:600px; height:650;">
			...
			<form>
				...
				<div class="btn-group" style="margin-left: 65%; padding-bottom:5%;">
					<button type="button" class="btn btn-primary" onclick="popup('/admin/manageUser/modifyUser?mid=${detail.mid}')">회원수정</button>
					<button type="button" class="btn btn-danger"  onclick="popup('/admin/manageUser/delUser?mid=${detail.mid}')">회원탈퇴</button>
				</div>
		    </form>
    	</div>
    </div>
