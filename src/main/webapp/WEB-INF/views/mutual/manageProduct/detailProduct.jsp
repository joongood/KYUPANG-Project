    	...
    	<div class="content-wrapper" style="width:700px; height:850;">
	     ...
	     <form enctype="multipart/form-data">
	       ...
	       <div class="form-group">
	        ...
	        <br>		
            <div class="btn-group" style="margin-left: 68%; padding-bottom:5%;">
				<button type="button" class="btn btn-primary" onclick="popup('/mutual/manageProduct/modifyProduct?pid=${detail.pid}')">상품수정</button>
				<button type="button" class="btn btn-danger"  onclick="popup('/mutual/manageProduct/delProduct?pid=${detail.pid}')">상품삭제</button>
			</div>
	       </form>
       </div>
   </div>
