                ...
                <div class="card-header">
                  <h3 class="card-title"><b>상품목록</b></h3>
         		  <div class="btn-group" style="margin-left:89%;">
 					<button type="button" class="btn btn-primary" onclick="popup('/mutual/manageProduct/addProduct')">상품추가</button>        		  
         		  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      <c:forEach var="product" items="${productList}">
                        <tr>
                          ...
                          <td><span onclick="popup('/mutual/manageProduct/detailProduct?pid=${product.pid}')">${product.pname}</span></td>
