                ...
                <div class="card-header">
                  <h3 class="card-title"><b>회원 목록</b></h3>
         		  <div class="btn-group" style="margin-left:89%;">
 					<button type="button" class="btn btn-primary" onclick="popup('/mutual/manageUser/addUser')">회원추가</button>        		  
         		  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="memberTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <c:forEach var="member" items="${memberList}">
                        <tr>
                          <td>${number }</td>
                          <td><a onclick="popup('/mutual/manageUser/detailUser?mid=${member.mid }')">${member.mname}</a></td>
                          <td>${member.memail}</td>
                          <td>${member.mphone}</td>
