    	...
    	<div class="content-wrapper">
	     ...
	     <form method="POST" enctype="multipart/form-data">
           ...
           <div class="form-group">
              ...
              <input type="text" class="form-control" id="mutual" name="mutual" value="${label}" readonly/>                        
           </div>
           <br>
           <div class="form-group">
               <label for="bprice">제안가격</label>
               <input type="text" class="form-control" id="bprice" name="bprice" required/>
           </div>
           <br>
		   ...
		   <br>		
           <button type="submit" class="btn btn-primary" id="addbutton">배너신청</button>
	       </form>
       </div>
   </div>
</body>
