                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><b>정산신청 및 거래관리</b></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="calList" items="${calList}">
                                                <tr>
                                                    ...
                                                    <td>${calList.cal}</td>
                                                    <td>
                                                        <c:if test="${calList.cal != '정산요청' && calList.cal != '정산완료'}">
                                                            <button id="requestButton" style="border:none; background:none; color:blue" onclick="popup('/mutual/manageCal/updateCal?ctid=${calList.ctid}')">정산요청</button>
                                                        </c:if>
                                                    </td>
                                                </tr>
